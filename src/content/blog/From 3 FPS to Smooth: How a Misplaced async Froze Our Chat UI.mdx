---
title: 'From 3 FPS to Smooth: How a Misplaced async Froze Our Chat UI'
description: 'I spent an hour staring at a flame graph before realizing the culprit was a single async keyword firing hundreds of microtasks per second — here is the diagnostic trail.'
pubDate: 'Dec 18 2025'
---
...
[react-scan](https://github.com/aidenybai/react-scan) automatically highlights re-rendering issues in a React app. After dropping it in and reproducing the lag, the syntax-highlighted code blocks lit up as an obvious offender:
...
<Image src={AfterPerformance} alt="Flame graph after fix showing reduced long tasks" />
